...
export DEPLOY_DIR=$(dialog --stdout --title "$MSG" --dselect ${PWD} 14 48)
...
SETTINGS_FOLDER=$(dialog --stdout --title "$MSG" --dselect ${PWD} 14 48)
dialog --msgbox "Setting settings folder to ${SETTINGS_FOLDER}"  8 60
...
TOMCAT_DISTRIBUTION=$(dialog --stdout --title "$MSG" --fselect ${PWD} 14 48)
dialog --msgbox "Tomcat dist: ${TOMCAT_DISTRIBUTION}"  8 60
...
MYSQL_CLIENT_JAR=$(dialog  --stdout --title "$MSG" --fselect ${PWD} 14 48)
dialog --msgbox "MYSQL CLIENT JAR: ${MYSQL_CLIENT_JAR}"  8 60
...
export MYSQL_CONNECTION_STRING=$(dialog --stdout --inputbox  "$MSG" 14 48 "${DEFAULT_MYSQL_CONNECTION_STRING}")
...
then
	...
	then
		...
		SITE_SPECIFIC_POLICIES_FILE=$(dialog  --stdout --title "$MSG" --fselect ${PWD} 14 48)
